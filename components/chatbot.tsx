  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi there! 👋 I'm Shree Gopala's AI Assistant. How can I assist you today? Feel free to ask about our products, services, certifications, or anything else!",
    },
  ])
                    ...
                    >
                      <div className="max-w-[80%] rounded-2xl px-4 py-2 bg-muted flex items-center gap-2">
                        <span className="flex space-x-1">
                          ...
                          <motion.span
                            animate={{ y: [0, -6, 0] }}
                            transition={{ duration: 0.4, repeat: Number.POSITIVE_INFINITY, repeatDelay: 0.2 }}
                            className="block w-2 h-2 bg-gray-500 rounded-full"
                          />
                          <motion.span
                            animate={{ y: [0, -6, 0] }}
                            transition={{ duration: 0.4, repeat: Number.POSITIVE_INFINITY, repeatDelay: 0.3 }}
                            className="block w-2 h-2 bg-gray-500 rounded-full"
                          />
                        </span>
                      </div>
